...
// Butoanele remove si complete in format SVG
var removeSVG =
...
// daca dau click pe add si exista text in camp, aduc acel text in to do
...
function completeItem() {
  ...
  // verific daca task-ul trebuie adus la lista completa sau readus in todo list
  var target =
    id === "todo"
...
function addItemToDOM(text, completed) {
  ...
  // aduc  click event pt indepartarea task-ului
  ...
  // aduc  click event pt indeplinirea task-ului
